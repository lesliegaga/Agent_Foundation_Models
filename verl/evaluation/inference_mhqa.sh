...
export EXPERIMENT_NAME="eval_7b_wiki_search"
export BASE_MODEL="your donwload model"
export VLLM_ATTENTION_BACKEND=XFORMERS # vllm + qwen2-7b with flash_attn has some issues
TRAIN_DATASETS="your train datasets"  #./data/A_qa_data/wiki_search/original_16w_column_filter.parquet
VAL_DATASETS="your val datasets"      #./data/A_qa_data/wiki_search/test_seven_dataset_all_column_filter.parquet
N_GPUS_PER_NODE=8
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    trainer.default_hdfs_dir=null \
    trainer.default_local_dir="${BASE_MODEL}${EXPERIMENT_NAME}" \
