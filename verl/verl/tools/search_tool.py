...
class SearchTool(BaseTool):
    ...
    def __init__(self, config: dict, tool_schema: OpenAIFunctionToolSchema):
        ...
        self.retrieval_service_url = value = os.environ.get('WIKI_RAG_SERVER_URL')
        assert self.retrieval_service_url, "Environment must have WIKI_RAG_SERVER_URL"
    ...
    def execute_search(self, instance_id: str, query_list: list, retrieval_service_url: str, topk: int, timeout: int):
        ...
        """
        # to make sure here query list is list of str without dics
        query_list = [str(query_maybe_dic_or_str) for query_maybe_dic_or_str in query_list]
    ...
    async def execute(self, instance_id: str, parameters: dict[str, Any], **kwargs) -> Tuple[str, float, dict]:
        ...
        assert isinstance(query, str), "[TYPE ERROR] query should be string"
        ...
        try:
            ...
            result_text = json.loads(result_text)['result']
